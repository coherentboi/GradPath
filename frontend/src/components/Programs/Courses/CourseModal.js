                        ...
                        <Box sx={{display: "flex", flexDirection: "row", height: "100%", width: "100%"}}>
                            ...
                            <Box sx={{display: "flex", width: {xs: "100%", md: "60%"}, height: "100%", marginLeft: {xs: "10px",md: "0px"}, flexDirection: "column"}}>
                                <Box sx={{display: "flex", width: "calc(100% - 5px)", marginRight: "10px", alignItems: "center"}}>
                                    ...
                                    <Button onClick={() => {navigate("/dashboard")}} sx={{fontSize: "14px", fontFamily: "Open Sans, sans-serif", padding: "8px 12px", backgroundColor: "primary.main", color: "white", marginRight: "10px", ":hover":{backgroundColor: "primary.main", filter: "brightness(75%)", transition: "0.3s"}}}>
                                        Book Now!
                                    </Button>
